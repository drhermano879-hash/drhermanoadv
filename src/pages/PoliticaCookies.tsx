...
export default function PoliticaCookies() {
  useSEO({
    title: 'Política de Cookies | Hermano Sousa Advogados',
    description: 'Informações transparentes sobre como utilizamos cookies para otimizar e personalizar sua experiência de navegação em nosso site.',
    canonicalUrl: 'https://hermanosousa.adv.br/politica-cookies',
